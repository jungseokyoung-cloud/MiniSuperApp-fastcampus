...
final class TopupInteractableMock: TopupInteractable {
    ...
    func addPaymentMethodDidAddCard(payment paymentMethod: PaymentMethod) {
    ...
    var cardOnFileDidSeletItemCallCoubt = 0
    var cardOnFileDidSeletIndex: Int?
    func cardOnFileDidSeletItem(at index: Int) {
        cardOnFileDidSeletItemCallCoubt += 1
        cardOnFileDidSeletIndex = index
    }
